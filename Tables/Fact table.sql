...
SELECT 'Dim_Date'        AS TableName, COUNT(*) AS Rows FROM Dim_Date        UNION ALL
SELECT 'Dim_Priority',                 COUNT(*)         FROM Dim_Priority     UNION ALL
SELECT 'Dim_Channel',                  COUNT(*)         FROM Dim_Channel      UNION ALL
SELECT 'Dim_Shop',                     COUNT(*)         FROM Dim_Shop         UNION ALL
SELECT 'Dim_Customer',                 COUNT(*)         FROM Dim_Customer     UNION ALL
SELECT 'Dim_Product',                  COUNT(*)         FROM Dim_Product      UNION ALL
SELECT 'Dim_Salesperson',              COUNT(*)         FROM Dim_Salesperson  UNION ALL
